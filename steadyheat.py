...
class SteadyHeat: 
    ...
    def plot(self): 
        ...
        axes[0].plot(x, self.finite_difference_solution, label="Finite Difference Solution")
        axes[0].plot(x, self.pinn_solution, label="PINN Solution")
        axes[0].plot(x, analytic, label="Analytic Solution")
        axes[0].set_xlabel("x [u]")
        axes[0].set_ylabel("y [u]")
        axes[0].legend()
        
        axes[1].semilogy(x, finite_difference_error, label="Finite Difference Error")
        axes[1].semilogy(x, pinn_error, label="PINN Error")
